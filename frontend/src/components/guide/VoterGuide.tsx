...
import { ChevronDown, ChevronUp, MessageSquare, Send, Loader2, FileText, Lightbulb, Shield, Eye, Users, CheckCircle2 } from 'lucide-react'
...
export default function VoterGuide({ token, userRole, currentPhase }: Props) {
